...
[CustomPropertyDrawer(typeof(Attribute_MinMaxSlider))]
public class Drawer_Attribute_MinMaxSlider : PropertyDrawer {

    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label){

        var minMaxAttribute = (Attribute_MinMaxSlider)attribute;
